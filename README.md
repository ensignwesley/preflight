...
- Projects
- Status page
- Status JSON data (`all_up: true`, exact twelve-service roster, and `generated_at` no more than 15 minutes old)
- Observatory page
...
- Forth health (`ok`, service identity, security headers) and a live WebSocket evaluation (`2 3 + .` → `5 ok`)
- Lisp page
- Markov page
- Pathfinder page
